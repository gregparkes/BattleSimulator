...
class Composite:
    ...
    def __init__(self, name: str, n: int, pos_dist=None,
                 init_ai="nearest", rolling_ai="nearest", decision_ai="aggressive"):
        self.name = name
        self.n = n
    ...
    def __repr__(self):
        return (f"Composite('{self.name}', n={self.n}, pos={self.pos}, " +
